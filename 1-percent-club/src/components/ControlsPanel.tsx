  ...
  return (
    <div className="controls-panel">
      <div className="controls-buttons">
        {phase === 'playing' ? (
          <button type="button" className="controls-button controls-button--primary" onClick={onConfirm} disabled={!canConfirm}>
      ...
      <details className="controls-legend">
        ...
        <ul>
          <li><kbd>1</kbd>–<kbd>4</kbd> select an option</li>
          <li><kbd>Enter</kbd> confirm answer / next question</li>
